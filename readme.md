...
Say you wanted to query a Kubernetes API server from inside a container as part of post-ex recon but there are eBPF-, AppArmor-, SELinux-, or some other syscall-based monitoring/blocking rules in place.
